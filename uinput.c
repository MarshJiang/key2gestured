...
static int scroll_scale_x = DEFAULT_SCROLL_SCALE_X;
static int scroll_scale_y = DEFAULT_SCROLL_SCALE_Y;
...
{
    if (scale_x > 0)
        scroll_scale_x = scale_x;
    if (scale_y > 0)
        scroll_scale_y = scale_y;
}
